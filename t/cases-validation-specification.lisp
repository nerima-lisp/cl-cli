...
(describe-sequential "validation specification"
  ...
  (it "rejects duplicate option names"
    (let ((left (make-option :name "verbose" :short #\v))
      ...
      (signals-invalid-specification
        (demo-app :global-options (list left right)))))
  ...
  (it "rejects duplicate command names"
    (let ((left (make-command :name "build"))
      ...
      (signals-invalid-specification
        (demo-app :commands (list left right)))))
  ...
  (it "rejects unsafe characters in a positional name when key is omitted"
    (signals-invalid-specification
      (make-positional :name "foo; rm")))

  (it "requires a positional's :complete to be a function"
    (signals-invalid-specification
      (make-positional :key :target :complete "not-a-function")))
